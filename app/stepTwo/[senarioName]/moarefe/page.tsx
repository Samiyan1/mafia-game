  ...
  return (
    <main className='h-screen w-screen'>
      ...
      {(finalListState.length > 0) ? (
        ...
        : (
          <Link href={`/stepTwo/${urlSenarioName}/rozeMoarefe`} className='w-[70vw] mx-auto'>
            <button className=' btn-play my-3'>
              <svg height="100px" width="100px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md h-[45vh] transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
